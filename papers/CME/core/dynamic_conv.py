...
class _ConvNd(nn.Cell):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
        ...
        '''
        if transposed:
            self.weight = Parameter(mindspore.Tensor(
        ...
        # if bias:
        #     self.bias = Parameter(mindspore.Tensor(out_channels))
        # else:
    ...
    class DynamicConv2d(_ConvNd):
        ...
        def forward(self, inputs):
            ...
            if self.partial is not None:
                ...
                dynamic_weight = mindspore.ops.Concat([shared_weight, dynamic_weight], dim=1)
            ...
            conv_rlt = nn.conv2d(input, dynamic_weight, self.bias, self.stride,
