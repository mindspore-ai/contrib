...
class Dehaze(nn.Cell):
    ...
    def __init__(self, input_nc, output_nc, ngf=64):
        ...
        self.up1 = nn.SequentialCell([nn.Conv2dTranspose(ngf*4, ngf*2, kernel_size=3, stride=2,
                                                         pad_mode='pad', padding=1),
                                      nn.ReLU()])
        self.up2 = nn.SequentialCell([nn.Conv2dTranspose(ngf*2, ngf, kernel_size=3, stride=2,
                                                         pad_mode='pad', padding=1),
...
class DehazeWithLossCell(nn.Cell):
    ...
    def construct(self, x, clear):
        ...
        loss = self.loss(output, clear, x, clear)
