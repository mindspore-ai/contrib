    ...
    def __init__(self, root, train=True,
        ...
        if self.train:
            ...
            if noise_type != 'clean':
                ...
                self.noise_or_not = np.transpose(self.train_noisy_labels) == np.transpose(training_labels)
        else:
...
def noisify_pairflip(y_train, noise, random_state=None, nb_classes=10):
    ...
    if n > 0.0:
        # 0 -> 1
        pair[0, 0], pair[0, 1] = 1. - n, n
        for i in range(1, nb_classes - 1):
            pair[i, i], pair[i, i + 1] = 1. - n, n
        pair[nb_classes - 1, nb_classes - 1], pair[nb_classes - 1, 0] = 1. - n, n

        y_train_noisy = multiclass_noisify(y_train, p=pair,
...
def noisify_multiclass_symmetric(y_train, noise, random_state=None, nb_classes=10):
    ...
    if n > 0.0:
        ...
        for i in range(1, nb_classes - 1):
            pair[i, i] = 1. - n
        pair[nb_classes - 1, nb_classes - 1] = 1. - n
