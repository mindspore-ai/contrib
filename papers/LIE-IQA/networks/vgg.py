...
from networks.var_init import default_recurisive_init, KaimingNormal
...
class Vgg(nn.Cell):
    ...
    def __init__(self, base, batch_norm=False, args=None):
...
def vgg16_feats(args=imagenet_cfg, **kwargs):
    """
    ...
    """
    net = Vgg(cfg['16'], args=args, batch_norm=False, **kwargs)
    return net
