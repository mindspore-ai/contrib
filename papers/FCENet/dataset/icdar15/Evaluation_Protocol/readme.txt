...
-p: JSON string parameters to override the script default parameters. The parameters that can be overridden are inside the function 'default_evaluation_params' located at the beginning of the evaluation Script.
