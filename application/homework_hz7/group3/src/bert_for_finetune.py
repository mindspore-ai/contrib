...
from .finetune_eval_model import BertCLSModel
...
class BertFinetuneCell(nn.Cell):
    ...
    def construct(self, data, sens=None):
        """Bert Finetune"""
...
class BertCLS(nn.Cell):
    ...
    def construct(self, input_ids, input_mask, frame, frame_mask, label_ids):
        """
        1
        :param input_ids: 1
        :param input_mask: 1
        ...
        :return: 1
        """
        # return self.bert(input_ids, input_mask, frame_ids, frame_mask)
        logits = self.bert(input_ids, input_mask, frame, frame_mask)
