...
class ProjContrastiveModel_BC1(nn.Cell):    
    ...
    def loss_calculation(self, z,c, num_classes, tau):
        ...
        CC = ops.sum(z.unsqueeze(1) * ONEHOT.unsqueeze(2) , dim=0) / ops.clamp( ONEHOT.sum(0).unsqueeze(-1), min=1.0)   
...
if __name__ == '__main__':
    ...
    model = ProjContrastiveModel_BC1(PROJECTION_DIM, EMBEDDING_DIM, NUM_CLASSES)
